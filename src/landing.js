...
const TESTIMONIALS = [
  {
    ...
    result: 'Obtuvo B2 ⭐',
    text: 'Aprobé el TEF con nivel B2. Los ejercicios son exactamente como el examen real y el temario específico me ahorró meses de búsqueda de material.',
  },
  {
    name: 'Carlos Mendoza',
    flag: '🇲🇽', country: 'México',
    result: 'Obtuvo B1 ⭐',
    text: 'El conjugador interactivo transformó mi francés. Pasé de huirle a los verbos a dominarlos en pocas semanas. ¡100% recomendado para el TEF!',
  },
  {
    name: 'Ana Ruiz',
    flag: '🇻🇪', country: 'Venezuela',
    result: 'Visa aprobada ✅',
    text: 'En 4 meses pasé de A1 a B1. Los ejercicios de Comprensión Oral son casi idénticos al TEF real. Mi visa de estudios a Canadá está aprobada.',
  },
  {
    name: 'Diego Torres',
    flag: '🇵🇪', country: 'Perú',
  ...
  },
  {
    ...
    result: 'Obtuvo B2 ⭐',
    text: 'El temario del TEF Canadá me dio exactamente lo que necesitaba — sin perder tiempo con material irrelevante para el examen de inmigración.',
  },
  {
    name: 'Roberto Sánchez',
    flag: '🇨🇱', country: 'Chile',
    result: 'Primer intento ✅',
    text: 'Pago único sin suscripciones: la mejor inversión para mi proceso migratorio. Aprobé el TEF en el primer intento con mucha confianza.',
  },
];
